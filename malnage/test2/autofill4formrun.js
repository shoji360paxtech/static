...
formrundiv.insertAdjacentHTML('beforebegin','<div style="font-size:13px;width:100%">マイページにログインし、情報を登録しておくと、メールアカウントを選択することで基本情報が自動で入力されます。</div><div id="malaccountdiv" style="width:100%;text-align:right"></div>')
